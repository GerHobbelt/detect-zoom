...
;(function (root, ns, factory) {
  ...
  /**
   * Detects zoom status for Blink engine (Chrome, Opera).
   * Bug - Engine returns 1.0 - 1.09 zoom values during resizing window (it depends from window size)
   * Trick: slice last digit
   * @return {Object}
   * @private
   */
  var blink = function() {
